...
2. Sau khi thực hiện xong, bước biếp theo chuẩn bị 2 file đó là "dynamic.rsb.smf" và "init.rsb.smf" [theo đường link này](https://drive.google.com/drive/folders/1zmeYb0VYpUJW1GbGMWWSkv5gwKs9KfHs) hoặc ngay trong mục release bằng các kéo xuống kéo trang đối với điện thoại và bên phải đối với pc
3. Tải app [ZAchiver](https://play.google.com/store/apps/details?id=ru.zdevs.zarchiver&hl=en) về điện thoại. Lưu ý, nếu hệ điều hành android từ 15 trở lên nên cài thêm app [Shizuku](https://play.google.com/store/apps/details?id=moe.shizuku.privileged.api&hl=en) hoặc [link này](https://shizuku-manager.en.uptodown.com/android) nếu không thể cài đặt trên ch play (mục đích cái apk đó để cấp quyền truy cập file **Android/Data**, bạn có thể tìm trên Youtube xem họ làm gì.)
4. Cách thực hiện:
